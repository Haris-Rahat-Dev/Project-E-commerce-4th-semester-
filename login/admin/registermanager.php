...
<body>
<h2 class="h2 my-5 text-center">Register New Manager</h2>
    ...
    <form class="container text-white" action="" method="post">
        <div class="row">
            ...
            <div class="col col-lg-6 col-md-12 col-sm-12">
                ...
                <input class="form-control"  type="email" placeholder="e.g haris@gsolutions.com" name="email">
